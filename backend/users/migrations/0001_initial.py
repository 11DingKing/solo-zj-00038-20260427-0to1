    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '平台管理员'), ('leader', '团长'), ('member', '团员')], default='member', max_length=20, verbose_name='角色')),
                ...
                ('leader_status', models.CharField(choices=[('pending', '待审核'), ('approved', '已通过'), ('rejected', '已拒绝')], default='pending', max_length=20, verbose_name='团长审核状态')),
                ('shop_name', models.CharField(blank=True, max_length=100, verbose_name='店铺名称')),
                ('shop_address', models.CharField(blank=True, max_length=255, verbose_name='店铺地址')),
